...
import { InstagramIcon, Twitter, Discord, Youtube, Facebook } from '../icons/icons'
...
const Socials = ({ className }) => {
    return (
        <ul className='socials animate--fade-in'>
            ...
            <li><a title='nrdstr community on discord' href='https://discord.gg/7tzT2R4F4M'><Discord /></a></li>
