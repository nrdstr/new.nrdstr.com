...
const SocialMediaDesign = () => (
    <Layout page='service-sm-design'>
        <SEO title='Social Media Design Services' description="We'll design you social media skins, profile pictures, banners, backgrounds, and  headers for your social media accounts. You want your brand to be easily identifiable no matter the platform, and we're here to help. Contact us today!" url='/services/social-media-design' />
